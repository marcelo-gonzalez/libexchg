...
int exchg_pair_base(enum exchg_currency *base, enum exchg_pair pair)
{
        static const enum exchg_currency bases[] = {
            EXCHG_CCY_BTC,  EXCHG_CCY_ETH, EXCHG_CCY_ETH, EXCHG_CCY_ZEC,
            EXCHG_CCY_ZEC,  EXCHG_CCY_ZEC, EXCHG_CCY_ZEC, EXCHG_CCY_ZEC,
            EXCHG_CCY_BCH,  EXCHG_CCY_BCH, EXCHG_CCY_BCH, EXCHG_CCY_LTC,
            EXCHG_CCY_LTC,  EXCHG_CCY_LTC, EXCHG_CCY_LTC, EXCHG_CCY_DAI,
            EXCHG_CCY_NEAR,
        };
...
int exchg_pair_counter(enum exchg_currency *counter, enum exchg_pair pair)
{
        static const enum exchg_currency counters[] = {
            EXCHG_CCY_USD, EXCHG_CCY_USD, EXCHG_CCY_BTC, EXCHG_CCY_USD,
            EXCHG_CCY_BTC, EXCHG_CCY_ETH, EXCHG_CCY_BCH, EXCHG_CCY_LTC,
            EXCHG_CCY_USD, EXCHG_CCY_BTC, EXCHG_CCY_ETH, EXCHG_CCY_USD,
            EXCHG_CCY_BTC, EXCHG_CCY_ETH, EXCHG_CCY_BCH, EXCHG_CCY_USD,
            EXCHG_CCY_USD,
        };
...
{
        return exchg_pair_base(base, pair) | exchg_pair_counter(counter, pair);
}

static int str_to_currency(enum exchg_currency *currency, const char *str,
                           size_t len)
{
